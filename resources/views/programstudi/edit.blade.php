			  	...
			  	<form action="{{ route('programstudi.update',$programstudi->id) }}" method="post" >
        			...
        			{{ csrf_field() }}
			  		...
			  		<div class="form-group {{ $errors->has('judul') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="judul" class="form-control" value="{{ $programstudi->judul }}"  required>
			  			@if ($errors->has('judul'))
                            <span class="help-block">
			  		...
			  		<div class="form-group {{ $errors->has('deskripsi') ? ' has-error' : '' }}">
			  			...
			  			<input type="text" name="deskripsi" class="form-control" value="{{ $programstudi->deskripsi }}"  required>
